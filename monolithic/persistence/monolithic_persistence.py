...
DATA_DIR = "/data" # este directorio seerá montando en el contenedor para persistir los datos y no perderlos al reiniciar el contenedor, además no esta en mi computadora de manera local.
